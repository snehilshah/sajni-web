...
export const qk = {
  ...
  finance: {
    ...
    pocket: (id: number) => ['finance', 'pocket', id] as const,
    pocketExpenses: (id: number) => ['finance', 'pocketExpenses', id] as const,
    pocketBalances: (id: number) => ['finance', 'pocketBalances', id] as const,
    pocketSettlements: (id: number) => ['finance', 'pocketSettlements', id] as const,
    pocketActivity: (id: number) => ['finance', 'pocketActivity', id] as const,
    pocketInvitePreview: (token: string) => ['finance', 'pocketInvite', token] as const,
